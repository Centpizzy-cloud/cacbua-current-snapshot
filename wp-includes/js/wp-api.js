...
( function() {
	...
	if ( _.isEmpty( wpApiSettings ) ) {
		wpApiSettings.root = window.location.origin + '/cacbua-current-snapshot/wp-json/';
	}
	...
	wp.api.init = function( args ) {
		...
		attributes.apiRoot        = args.apiRoot || wpApiSettings.root || '/cacbua-current-snapshot/wp-json';
